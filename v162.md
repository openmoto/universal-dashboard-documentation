# [v1.6.2](https://www.powershellgallery.com/packages/UniversalDashboard/1.6.2)

**Released: June 5th, 2018**

* [\#84](https://github.com/ironmansoftware/universal-dashboard/issues/84) - RestEndpoint : conversion error when the parameter type is defined to Int when using POST method 
