...
Just as with `New-UDChart`, the standard bar chart is available. It easily supports multiple datasets and can be stacked, grouped or layed outed horizontally. 
