...
### Url
```
New-UDImage -Url <String> [-Height <Int32>] [-Width <Int32>] [-Endpoint <ScriptBlock>] [-AutoRefresh]
 [-RefreshInterval <Int32>] [-DebugEndpoint] [-Id <String>] [<CommonParameters>]
```

### Path
```
New-UDImage -Path <String> [-Height <Int32>] [-Width <Int32>] [-Endpoint <ScriptBlock>] [-AutoRefresh]
 [-RefreshInterval <Int32>] [-DebugEndpoint] [-Id <String>] [<CommonParameters>]
```
...
### -Path
Path to the image file to include.
