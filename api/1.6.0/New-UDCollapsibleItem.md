...
```
New-UDCollapsibleItem [-Title <String>] [-Icon <FontAwesomeIcons>] [-Content <ScriptBlock>] [-Active]
 [-Endpoint <ScriptBlock>] [-AutoRefresh] [-RefreshInterval <Int32>] [-DebugEndpoint]
 [-BackgroundColor <DashboardColor>] [-FontColor <DashboardColor>] [-Id <String>] [<CommonParameters>]
```
