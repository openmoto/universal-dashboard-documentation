...
### text (Default)
```
New-UDCard [[-Title] <String>] [[-Text] <String>] [[-Links] <Link[]>] [[-BackgroundColor] <DashboardColor>]
 [[-FontColor] <DashboardColor>] [[-Watermark] <FontAwesomeIcons>] [[-TextSize] <TextSize>]
 [[-TextAlignment] <TextAlignment>] [-Language <String>] [-Id <String>] [<CommonParameters>]
```

### content
```
New-UDCard [[-Title] <String>] [[-Links] <Link[]>] [[-BackgroundColor] <DashboardColor>]
 [[-FontColor] <DashboardColor>] [[-Watermark] <FontAwesomeIcons>] [-Language <String>]
 [-Content <ScriptBlock>] [-Id <String>] [<CommonParameters>]
```
...
### -Watermark
An icon watermark to present within the card. 
