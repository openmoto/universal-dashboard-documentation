# [v1.4.0](https://www.powershellgallery.com/packages/UniversalDashboard/1.4.0)
...
Themes can now be selected with the `Get-UDTheme` cmdlet. There are 2 built in themes to choose from. Themes can be provided to the `New-UDDashboard` cmdlet. 
